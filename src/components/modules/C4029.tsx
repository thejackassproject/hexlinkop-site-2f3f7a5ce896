...
export default function C4029({
  heading = "Discover Insights About Businesses",
  description = "Explore comprehensive information on businesses, trends, and strategies. Learn how businesses operate and succeed in today's dynamic market.",
  primaryButton = {
    text: "About Us",
    url: "/about"
  },
        ...
        <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-primary via-primary/90 to-accent p-12 shadow-2xl lg:p-16">
          ...
          <div className="relative z-10 flex flex-col items-center text-center">
            <div className="mb-6 inline-flex items-center gap-2 rounded-full bg-white/20 px-4 py-2 backdrop-blur-sm">
              ...
              <span className="text-sm font-medium text-white">Business Insights Await</span>
            </div>
